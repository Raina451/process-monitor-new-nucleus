  ...
  if (instances.length === 0) {
    return (
      <div className="border border-gray-200 rounded-lg p-12 text-center">
        ...
        <p className="text-sm font-medium text-gray-900">No process instances found</p>
        <p className="text-sm text-gray-500 mt-1">Try adjusting your filters or wait for new instances to start</p>
      </div>
    );
  }
  return (
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Instance Name</th>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {instances.map((instance) => (
              <tr key={instance.instanceId} className="hover:bg-gray-50 transition-colors">
